...
BC.Function.define("find",function(request,response,modules){
...
BC.Function.define("findone",function(request,response,modules){
  var query = modules.oData;
...
BC.Function.define("test",function(request,response,modules){
	var query = modules.oData;
	var test = query.find({
      "table":"GameScore"
    },function(err,data){
